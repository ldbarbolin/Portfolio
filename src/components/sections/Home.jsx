      ...
      <div className="container mx-auto h-full px-4 pt-20 md:pt-0">
        <div className="flex flex-col xl:flex-row items-center justify-center">
          <div className="text-center z-10">
            ...
            <div className="grid grid-cols-1 md:flex gap-6 mb-8 xl:mb-0">
              ...
              <div className="flex justify-center items-center">
                <div className="h-11 w-55 gap-2 border border-amber-500 rounded-full px-3 flex items-center text-amber-500 text-base hover:bg-amber-500 hover:text-black hover:transition-all duration-500">
                  <Mail />
